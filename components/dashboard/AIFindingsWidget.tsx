...
export function AIFindingsWidget() {
  ...
  return (
    <GlassCard className="flex flex-col gap-3 min-h-0 bg-slate-900/25 backdrop-blur-3xl">
      <div className="flex items-center justify-between relative mb-0.5" ref={menuRef}>
        <h2 className="text-lg font-bold text-white">AI Findings & Recommendations</h2>
        <button
          type="button"
